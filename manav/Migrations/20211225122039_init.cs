        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SiparisID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SiparisDetayi = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SiparisTutari = table.Column<int>(type: "int", nullable: false),
                    MüsteriAdi = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MüsteriAdresi = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MüsteriTel = table.Column<int>(type: "int", nullable: false),
                    MüsteriEmail = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrunResim = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    KategoriID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
